...
public class GUI_OtherMenuHomeMenu1 : MonoBehaviour {
	...
	public static GameObject				imageSlideShow_buttons_next_text_Other_127_gameObject;
	...
	public static GameObject				imageSlideShow_buttons_previous_text_Other_128_gameObject;
	...
	public static GameObject				imageSlideShow_buttons_back_text_Other_129_gameObject;
	...
	public static GameObject				input_name_placeholder_Other_130_gameObject;

	public static GameObject				input_name_text_Other_131_gameObject;
	...
	public static GameObject				input_email_placeholder_Other_132_gameObject;

	public static GameObject				input_email_text_Other_133_gameObject;
	...
	public static void UpdateValues(GameObject panel){
		...
		imageSlideShow_buttons_next_text_Other_127_gameObject = imageSlideShow_buttons_next_Button_gameObject.transform.Find("Text").gameObject;
		...
		imageSlideShow_buttons_previous_text_Other_128_gameObject = imageSlideShow_buttons_previous_Button_gameObject.transform.Find("Text").gameObject;
		...
		imageSlideShow_buttons_back_text_Other_129_gameObject = imageSlideShow_buttons_back_Button_gameObject.transform.Find("Text").gameObject;
		...
		input_name_placeholder_Other_130_gameObject = input_name_InputField_gameObject.transform.Find("Placeholder").gameObject;

		input_name_text_Other_131_gameObject = input_name_InputField_gameObject.transform.Find("Text").gameObject;
		...
		input_email_placeholder_Other_132_gameObject = input_email_InputField_gameObject.transform.Find("Placeholder").gameObject;

		input_email_text_Other_133_gameObject = input_email_InputField_gameObject.transform.Find("Text").gameObject;
